    ...
    function paintMaze(maze){
      ...
      plane_ground.setAttribute('shadow', 'receive:true')
      ...
      var box_price = document.createElement("a-box");
          ...
          box_price.setAttribute('on-gaze', '');
          box_price.setAttribute('height', 4);
          box_price.setAttribute('width',3);
          box_price.setAttribute('color', "#FF07CF")
          box_price.setAttribute('depth',3);
          box_price.setAttribute('rotation','0 0 0');
          box_price.setAttribute('position',(3*(free2-(maze_width-1)*.5))+' 1.45 '+(3*(free1-(maze_height-1)*.5)));
          box_price.setAttribute('material', 'src: #door');
          box_price.setAttribute('light', 'color: #ff00e1; groundColor: #ff00e1; decay: 3; angle: 35; distance: 5; intensity: 16; type: point');
